...
# Focus tab
<user.teleport> tab <user.rango_target>:
  user.rango_command_with_target("activateTab", rango_target)
markers refresh:         user.rango_command_without_target("refreshTabMarkers")
...
next page:                  user.rango_command_without_target("navigateToNextPage")
last page:                  user.rango_command_without_target("navigateToPreviousPage")

# Move current tab to a new window
split tab:                  user.rango_command_without_target("moveCurrentTabToNewWindow")

# Focus previous tab
last tab:                   user.rango_command_without_target("focusPreviousTab")

# Close tabs
close other tabs:           user.rango_command_without_target("closeOtherTabsInWindow")
close left tabs:            user.rango_command_without_target("closeTabsToTheLeftInWindow")
close right tabs:           user.rango_command_without_target("closeTabsToTheRightInWindow")
close first tab [<number_small>]:
  user.rango_command_without_target("closeTabsLeftEndInWindow", number_small or 1)
close final tab [<number_small>]:
  user.rango_command_without_target("closeTabsRightEndInWindow", number_small or 1)
close previous tab [<number_small>]:
  user.rango_command_without_target("closePreviousTabsInWindow", number_small or 1)
close next tab [<number_small>]:
